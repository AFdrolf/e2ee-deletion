...
\paragraph{Motivation.} There are many natural scenarios in which one would want such privacy guarantees for message deletion features, and for them not to just as UI or storage cleanup. 

\andres{In a nutshell, without deletion security, we loose deniability in the face of device compromise.}
